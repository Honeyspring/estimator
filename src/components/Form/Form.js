...
const Form =({onFormSubmit,onNameChange,onAvgAgechange,onAvgDailyIncomeInUSDChange, onPopulationChange,onPeriodTypeSelect,onReportedCasesChange,onTimeToElapseChange,onTotalHospitalBedsChange,onAvgDailyIncomePopulationChange,FormError})=>{
    ...
    return(
        ...
        <div className="mt3 ">
            ...
            <label className="db fw6 lh-copy f6"  htmlFor="data-name">name</label>
         ...
         <div className="mt3 ">
            <label className="db fw6 lh-copy f6"  htmlFor="data-avg-age">Average Age</label>
         ...
         <div className="mt3 ">
            <label className="db fw6 lh-copy f6"  htmlFor="data-avg-daily-income-in-usd">Average Daily Income In USD</label>
         ...
         <div className="mt3 ">
            <label className="db fw6 lh-copy f6"  htmlFor="data-avgDaily-income-population">Average Daily Income Population</label>
         ...
         <div className="mt3 ">
            <label className="db fw6 lh-copy f6"  htmlFor="data-period-type">Period Type</label>
        ...
        <div className="mv3 ">
            <label className="db fw6 lh-copy f6 "  htmlFor="data-time-to-elapse" >Time To Elapse </label> 
        ...
        <div className="mv3 ">
            <label className="db fw6 lh-copy f6 "  htmlFor="data-reported-cases" >Reported Cases</label>
         ...
         <div className="mv3 ">
            <label className="db fw6 lh-copy f6 "  htmlFor="data-population" >Population</label> 
             <label className="db fw6 lh-copy f6 FormError"  htmlFor="FormError">{FormError.FormTimeToElapse }</label>      
         ...
         <div className="mv3 ">
            <label className="db fw6 lh-copy f6 "  htmlFor="data-total-hospital-beds" >Total Hospital Beds</label>  
